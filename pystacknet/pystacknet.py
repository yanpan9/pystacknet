...
class StackNetClassifier(BaseEstimator, ClassifierMixin):
  ...
  def __init__(self, models, metric="logloss", folds=3, cv_title="KFold", restacking=False, use_retraining=True, use_proba=True, random_state=12345, n_jobs=1, verbose=0):
                ...
                for d in range (len(this_level_models)):
                    ...
                    if  self.use_proba:
                        if hasattr(this_model, 'predict_proba') :
                            ...
                            result[level*len(self.models[0])+d, i] = metrics_i[d]
                            if self.verbose>0:
